...
import { extraProductsData } from "../../data/productDataThree";
...
export default function ProductSlider({ category }: ProductSliderProps) {
  const products = extraProductsData[category];

   const categoryHeadings: Record<ProductSliderProps["category"], string> = {
    belt: "Reversible Formal Belts - 35mm",
    wallet: "Wallets - Coin Bill Fold",
    bag: "Duffle Bags / Back Pack",
  };
